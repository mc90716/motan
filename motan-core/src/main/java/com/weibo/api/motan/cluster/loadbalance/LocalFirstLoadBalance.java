...
public class LocalFirstLoadBalance<T> extends AbstractLoadBalance<T> {
    private static final int MAX_REFERER_COUNT = 10;
    private static Random random = new Random();

    private static long ipToLong(final String addr) {
    ...
    private static class LowActivePriorityComparator<T> implements Comparator<Referer<T>> {
        @Override
